...
def just_label(item_id):
    ...
    return render_template('just_label.html', item_id=item_id, sen_count=sen_count, islabel_count=islabel_count, zhanbi=zhanbi,fenju=str(fenju),entity_type = entity_type, relation_type = relation_type)
